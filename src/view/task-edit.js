...
const createTaskEditorDateTemplate = (dueDate, isDueDate) => {
...
const createTaskEditorRepeatingTemplate = (repeating, isRepeating) => {
...
const createTaskEditorTemplate = (data) => {
  const {color, description, dueDate, repeating, isDueDate, isRepeating} = data;

  const deadlineClassName = isTaskExpired(dueDate) ?
    `card--deadline` :
    ``;
  const dateTemplate = createTaskEditorDateTemplate(dueDate, isDueDate);

  const repeatingClassName = isRepeating ?
    `card--repeat` :
    ``;
  const repeatingTemplate = createTaskEditorRepeatingTemplate(repeating, isRepeating);
